          ...
          >
            ...
            <div className="grid gap-12 lg:grid-cols-2">
              <motion.div 
                ...
                viewport={{  amount: 0.8 }}
              >
                <h3 className="text-2xl text-white font-semibold tracking-tight font">Bachelor of Engineering in Computer Science & Engineering</h3>
              ...
              <motion.div 
                ...
                viewport={{  amount: 0.8 }}
              >
                <p className="text-justify text-white font">
                  I am currently enrolled in a Bachelor's in Computer Science & Engineering at Shri S'ad Vidyamandal Institute of technology, Bharuch, India, working towards my undergraduate degree.
                  CGPA : 8.96
                </p>
              ...
              <motion.div 
                ...
                viewport={{ amount: 0.8 }}
              >
                <h3 className="text-2xl text-white font-semibold tracking-tight font">HSC • Jay Ambe group of schools</h3>
              ...
              <motion.div 
                ...
                viewport={{ amount: 0.8 }}
              >
                <ul className="grid gap-2 list-disc list-outside text-white sm:grid-cols-2 font">
                  <li>Grade - B2</li>
                  <li>Percentage – 70%</li>
                </ul>
              </motion.div>
              <motion.div 
                ...
                viewport={{ amount: 0.8 }}
              >
                <h3 className="text-2xl font-semibold tracking-tight text-white font">SSC • Jay Ambe group of schools</h3>
                <p className="text-white font">Gujarat Secondary and Higher Secondary Education Board</p>
              ...
              <motion.div 
                ...
                viewport={{ amount: 0.8 }}
              >
                <ul className="grid gap-2 list-disc text-white list-outside sm:grid-cols-2 font">
                  <li>Grade - A2</li>
                  <li>Percentage – 86%</li>
                </ul>
              </motion.div>
