...
const Contact = () => {
    ...
    return (
        <>
            <div className='bg-[#000415]' id='contact'>
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <motion.h2
                        className="mb-4 text-[3rem] tracking-tight font-extrabold text-center text-[#0644ff]"
                    ...
                    <motion.p
                        className="mb-8 lg:mb-16 font-light text-center text-gray-400 sm:text-xl"
                        initial={{ opacity: 0, y: 50 }}
                        whileInView={{ opacity: 1, y: 0 }}
